...
(function () {
  ...
  function getTripStatistics() {
    return window.TL.Api.get("/admin/trips-admin/statistics");
  }
  ...
  function updateTrip(tripId, data) {
    return window.TL.Api.put(`/admin/trips-admin/${encodeURIComponent(tripId)}`, data);
  }

  // DELETE /admin/trips-admin/{trip}
  function deleteTrip(tripId) {
    return window.TL.Api.delete(`/admin/trips-admin/${encodeURIComponent(tripId)}`);
  }
